...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#032743' }}>
      {/* Mobile Hero Section */}
      <div className="md:hidden" ref={heroSection.ref}>
        ...
        >
          ...
          {/* Bumraah Hero Image - moved up by reducing flex-1 and adding negative margin */}
          <div className={`flex items-center justify-center px-6 animate-scaleIn animate-delay-600 ${heroSection.isIntersecting ? 'animate-on-scroll' : ''}`} style={{ marginTop: '20px' }}>
            <img 
              src="/frontend-images/homepage/bumraahheropic.png" 
              alt="Bumraah Hero" 
