          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <div className="rounded-[20px] border border-white/10 bg-white/10 p-6 shadow-[0_8px_32px_rgba(31,38,135,0.25)] backdrop-blur-xl">
                ...
                {/* File Information */}
                {videoUrl && fileName && (
                  <div className="p-4 backdrop-blur-md border border-white/20 rounded-lg">
                    <div className="text-center">
                      <p 
                        className="text-white mb-1"
                        style={{
                      ...
                      <div className="flex justify-center gap-4 text-white text-xs opacity-70">
                        <span>Duration: {videoDuration}</span>
                        {fileSizeLabel && <span>Size: {fileSizeLabel}</span>}
                        {mimeType && <span>Format: {mimeType}</span>}
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
              <button
                onClick={startAnalysis}
                disabled={state.isAnalyzing || !videoUrl}
                className="inline-flex items-center justify-center text-black font-bold transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
                  backgroundColor: '#FFC315',
                  borderRadius: '25.62px',
                  fontFamily: 'Frutiger, Inter, sans-serif',
              ...
              <Link 
                href="/record-upload"
                className="inline-flex items-center justify-center text-white font-bold transition-all duration-300 transform hover:scale-105"
                style={{
                  backgroundColor: 'rgba(255, 255, 255, 0.1)',
                  borderRadius: '25.62px',
                  fontFamily: 'Frutiger, Inter, sans-serif',
            ...
            {state.isAnalyzing && (
              <div className="rounded-[20px] border border-white/10 bg-white/10 p-6 shadow-[0_8px_32px_rgba(31,38,135,0.25)] backdrop-blur-xl">
                <h4 className="text-lg font-semibold text-white mb-4 text-center">Analysis Progress</h4>
                <div className="w-full bg-white/20 rounded-full h-3 border border-white/30">
                  <div 
                    className="bg-[#FFC315] h-3 rounded-full transition-all duration-300"
                    style={{ width: `${state.progress}%` }}
                  ></div>
                </div>
                <p className="text-sm text-white/80 mt-2 text-center">{Math.round(state.progress)}% complete</p>
              </div>
            )}
          </div>
        </div>
