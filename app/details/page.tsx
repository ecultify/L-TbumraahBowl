              ...
              <div className="relative flex flex-col items-center justify-center" style={{ height: '100%', paddingTop: 40, paddingBottom: 40, zIndex: 2 }}>
                ...
                <DetailsCard
                  ...
                  onSubmit={async (payload) => {
                    console.log('📝 User details submitted:', payload);
                    
                    // Store player name and details in sessionStorage
                    if (typeof window !== 'undefined') {
                      ...
                      window.sessionStorage.setItem('userFlow', 'details');
                      console.log('✅ Details completed - flag set in sessionStorage');
                      console.log('✅ Player name stored:', payload.name);
                      console.log('✅ User flow initialized: details');
                      
                      // Check if this is a returning user with existing content
                      ...
                      if (isReturningUser && hasCompositeCard) {
                        console.log('🔄 Returning user with composite card - redirecting to analyze page');
                        router.push('/analyze');
                        return;
                      }
                    }
                    
                    // Navigate to record/upload page for new users
                    console.log('➡️ Navigating to record/upload page');
